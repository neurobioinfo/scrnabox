...
# PARSE ARGUMENTS
############
if ! options=$(getopt --name $(basename $0) --alternative --unquoted --options hr:e:o:b: --longoptions export:,output:,bash0:,help -- "$@")
then
