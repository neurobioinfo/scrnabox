...
echo "-------------------------------------------"
echo "step7 markergsea submitted at `date +%FT%H.%M.%S`" 
echo "-------------------------------------------"
...
Rscript ${PIPELINE_HOME}/scrna/scripts/step7/scrna_step7_markergsea.R $OUTPUT_DIR  $R_LIB_PATH $PIPELINE_HOME
