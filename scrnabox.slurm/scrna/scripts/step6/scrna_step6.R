...
# Do the PCA
# seu_int <- FindVariableFeatures(seu_int, selection.method = par_FindVariableFeatures_selection.method, nfeatures = par_FindVariableFeatures_nfeatures)

# seu_int <- RunPCA(seu_int)  # should use variable ft by default

# png(paste(output_dir,"/elbow_pca.png", sep=""))
